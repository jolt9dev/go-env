...
type ExpandOption func(*ExpandParams)

func WithGet(f func(string) string) ExpandOption {
	return func(p *ExpandParams) {
		p.Get = f
	}
}
...
func WithUnixArgs() ExpandOption {
	return func(p *ExpandParams) {
		p.UnixArgs = true
	}
}
...
func Expand(template string, options ...ExpandOption) (string, error) {
